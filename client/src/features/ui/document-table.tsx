...
const getDocumentTypeColor = (type: string) => {
  const colors: Record<string, string> = {
    contract: "blue",
    contract_addendum: "blue",
    invoice: "geekblue",
    sales_invoice: "geekblue",
    act: "purple",
    reconciliation_act: "purple",
    handover_act: "purple",
    defect_installation_act: "purple",
    write_off_act: "purple",
    report: "cyan",
    cash_z_report: "cyan",
    financial_reports: "cyan",
    letter: "magenta",
    incoming_letter: "green",
    outgoing_letter: "volcano",
    order: "orange",
    cash_receipt_order: "orange",
    cash_expenditure_order: "orange",
    employment_order: "orange",
    termination_order: "orange",
    vacation_order: "orange",
    business_trip_order: "orange",
    other: "default",
    legal_documents: "red",
    production_form: "lime",
    warehouse_transfer: "gold",
    sick_leave: "volcano",
    protocol: "geekblue",
    timesheet: "cyan",
    waybill_requisition: "purple",
  };
