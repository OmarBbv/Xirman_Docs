  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-[23px] font-normal text-[#1d2327]">İstifadəçilər</h2>
      ...
      <ul className="flex items-center space-x-2 text-[13px] text-[#2271b1]">
        <li className="text-black font-semibold">Hamısı (3)</li>
        <span className="text-[#c3c4c7]">|</span>
        <li className="cursor-pointer hover:text-[#135e96]">Admin (1)</li>
        <span className="text-[#c3c4c7]">|</span>
        <li className="cursor-pointer hover:text-[#135e96]">Editor (1)</li>
        <span className="text-[#c3c4c7]">|</span>
        <li className="cursor-pointer hover:text-[#135e96]">Müəllif (1)</li>
      </ul>
      ...
      {/* Reusing the WP Table Component */}
      <Table data={users} />
